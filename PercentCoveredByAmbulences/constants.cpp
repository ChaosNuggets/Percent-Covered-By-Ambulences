...
const double LOWEST_LAT = 37.779567; // Lowest latitude that I have in points
const double LOWEST_LONG = -88.057587; // Lowest longitude that I have in points
const double HIGHEST_LAT = 41.760356; // Highest latitude that I have in points
const double HIGHEST_LONG = -84.805966; // Highest longitude that I have in points
...
const double MILES_BETWEEN_POINTS = 8; // Controls the density of the points
